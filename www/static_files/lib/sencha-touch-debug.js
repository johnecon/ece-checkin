...
&lt;tpl <b>if</b>="needsIcon">&lt;img app="{icon}" class="{iconCls}"/>&lt;/tpl>
// no good:
...
Ext.data.ServerProxy = Ext.extend(Ext.data.Proxy, {
    ...
    doRequest: function(operation, callback, scope) {
        throw new Error("The doRequest function has not been implemented on your Ext.data.ServerProxy subclass. See app/data/ServerProxy.js for details");
    },
...
Ext.data.ClientProxy = Ext.extend(Ext.data.Proxy, {
    ...
    clear: function() {
        throw new Error("The Ext.data.ClientProxy subclass that you are using has not defined a 'clear' function. See app/data/ClientProxy.js for details.");
    }
});
